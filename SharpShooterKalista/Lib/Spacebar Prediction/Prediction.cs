...
namespace SPrediction
{
    ...
    public static class Prediction
    {
        ...
        public static Menu Initialize(Menu spredMenu)
        {
            try
            {
                PathTracker.Initialize();
                ...
                ConfigMenu.Initialize(spredMenu);
                Drawings.Initialize();
            ...
            catch
            {
                ...
                m.Add("PREDICTONLIST", new ComboBox("Prediction Method", 1, "SPrediction", "Common Prediction"));
                return m;
            }
        }
