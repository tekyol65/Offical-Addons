...
namespace PortAIO
{
    ...
    class AutoLevel
    {
        ...
        public static void _AutoSpell()
        {
            ...
            var qL = Champions.Vayne.Program.Q.Level + QOff;
            var wL = Champions.Vayne.Program.W.Level + WOff;
            var eL = Champions.Vayne.Program.E.Level + EOff;
            var rL = Champions.Vayne.Program.R.Level + ROff;
