...
namespace SoloVayne.Skills.Condemn
{
    class CondemnLogicProvider
    {
        ...
        {
            var HeroList = HeroManager.Enemies.Where(h => h.LSIsValidTarget(PortAIO.Champions.Vayne.Program.E.Range) && !h.HasBuffOfType(BuffType.SpellShield) && !h.HasBuffOfType(BuffType.SpellImmunity));
            ...
            foreach (var Hero in HeroList)
            {
                ...
                var prediction = PortAIO.Champions.Vayne.Program.E2.GetPrediction(Hero);
